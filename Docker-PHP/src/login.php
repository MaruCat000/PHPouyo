...
try {
    ...
    // 修正前：$pdo = new PDO('mysql:host=localhost;dbname=twitter;charset=utf8', 'root', '');
    // 修正後：Docker用に用意した変数を使って接続します
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        // パスワード入力のチェック
            ...
            */
            ...
            // XAMMPの設定からDockerの設定に変更
            //$dsn = "mysql:dbname=twitter;host=mysql;charset=utf8mb4"; // [ ] は不要
            // 修正前: dbname=twitter
            //$dsn = "mysql:dbname=php-docker-db;host=mysql;charset=utf8mb4";
            //$dsn = "mysql:dbname=php-docker-db;host=mysql;port=3306;charset=utf8mb4";
            ...
            // 1. dbnameを .env の twitter に合わせる
            // 2. port=3306 を明示してソケットエラーを回避する
